                    ...
                    <div class="col-md-9 register-right">
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <h3 class="register-heading">DONATE ORGAN</h3>
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <textarea name="organ" class="form-control" placeholder="Enter Organ To Donate" required></textarea>
                                        </div>
                                        <div class="form-group">
                                            <textarea name="symptoms" class="form-control" placeholder="Enter Desease (If Any Else Enter NA)" required></textarea>
                                        </div>
